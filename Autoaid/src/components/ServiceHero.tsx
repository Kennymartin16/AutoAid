    ...
    <>
      <div className=" p-14 mt-4 items-center mx-auto">
        <div className="flex  flex-col md:flex-row md:relative lg:relative mx-auto">
          ...
          <div className="bg-dark-gray md:absolute w-4/4  md:right-40 md:max-w-full md:-mt-8  md:p-16 text-white md:h-full">
            <div className="md:mt-12 md:min-w-3.5/4">
              ...
              <p className="leading-6 text-center md:text-start p-1 md:leading-8 md:max-w-xl my-8">
